                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <span class="d-none d-lg-inline-block">Nazmul Anik</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        ...
                        <div class="d-inline-block">
                          Nazmul Anik <small class="pt-1">anikology@gmail.com</small>
                        </div>
                      </li>
        ...
        <div class="content-wrapper">
          <div class="content">
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2019</span> Copyright HRM ADMIN by
                <a
                  class="text-primary"
                  href="https://trillionbits.com/"
                  target="_blank"
                  >Trillionbits</a
                >.
              </p>
