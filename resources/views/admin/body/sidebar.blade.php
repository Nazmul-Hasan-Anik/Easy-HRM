  ...
  <div id="sidebar" class="sidebar sidebar-with-footer">
    ...
    <div class="sidebar-scrollbar">
      ...
      <ul class="nav sidebar-inner" id="sidebar-menu">
          ...
          <li  class="has-sub active expand" >
            ...
            <ul  class="collapse show"  id="dashboard"
              ...
              <div class="sub-menu">
                  ...
                  <li  class="active" >
                      <a class="sidenav-item-link" href="{{route('departments')}}">
          ...
          <li  class="has-sub active expand" >
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#pim"
              aria-expanded="false" aria-controls="dashboard">
              <i class="mdi mdi-view-dashboard-outline"></i>
              <span class="nav-text">PIM</span> <b class="caret"></b>
            </a>
            <ul  class="collapse show"  id="pim"
              data-parent="#sidebar-menu">
              <div class="sub-menu">
                  ...
                  <li  class="active" >
                    ...
                    <li  class="active" >
                        <a class="sidenav-item-link" href="{{route('designations')}}">
          ...
          <li  class="has-sub active expand" >
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#leave"
              aria-expanded="false" aria-controls="dashboard">
              <i class="mdi mdi-view-dashboard-outline"></i>
              <span class="nav-text">Leave</span> <b class="caret"></b>
            </a>
            <ul  class="collapse show"  id="leave"
              data-parent="#sidebar-menu">
              <div class="sub-menu">
                    ...
                    <li  class="active" >
                      <a class="sidenav-item-link" href="">
                        <span class="nav-text">Leave List</span>
                  ...
                  <li  class="active" >
                      <a class="sidenav-item-link" href="">
                        <span class="nav-text">Applied Leave</span>
          ...
          <li  class="has-sub active expand" >
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#time"
              aria-expanded="false" aria-controls="dashboard">
              <i class="mdi mdi-view-dashboard-outline"></i>
              <span class="nav-text">Time</span> <b class="caret"></b>
            </a>
            <ul  class="collapse show"  id="time"
              data-parent="#sidebar-menu">
              <div class="sub-menu">
          ...
          <li  class="has-sub active expand" >
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#recruitement"
              aria-expanded="false" aria-controls="dashboard">
              <i class="mdi mdi-view-dashboard-outline"></i>
              <span class="nav-text">Recruitement</span> <b class="caret"></b>
            </a>
            <ul  class="collapse show"  id="recruitement"
              data-parent="#sidebar-menu">
              <div class="sub-menu">
          ...
          <li  class="has-sub active expand" >
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#performance"
              aria-expanded="false" aria-controls="dashboard">
              <i class="mdi mdi-view-dashboard-outline"></i>
              <span class="nav-text">Performance</span> <b class="caret"></b>
            </a>
            <ul  class="collapse show"  id="performance"
              data-parent="#sidebar-menu">
              <div class="sub-menu">
                    ...
                    <li  class="active" >
                      <a class="sidenav-item-link" href="">
                        <span class="nav-text">Employee Tracker</span>

                      </a>
                    </li>
                    <li  class="active" >
                      <a class="sidenav-item-link" href="">
                        <span class="nav-text">Project Review</span>
          ...
          <li  class="has-sub active expand" >
            ...
            <ul  class="collapse show"  id="accounts"
              data-parent="#sidebar-menu">
              <div class="sub-menu">
