...
<div class="container">
  ...
  <td>  <a href="{{route('edit.dept',$dept->id)}}">{{$dept->department_name}} </a></td>

      <td><a href="{{route('delete.dept',$dept->id)}}"class="btn btn-danger" onclick="return confirm('are you sure?')">Delete</a></td>
  </tr>
    @endforeach
  </tbody>
</table>
